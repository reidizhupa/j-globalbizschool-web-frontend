	...
	return (
		<section className="relative overflow-hidden">
			...
			<div
				...
				style={{
					backgroundImage: `url('/img/hello.png')`, // Put your image in public/img/
			...
			<div className="relative z-10 max-w-7xl mx-auto px-6">
				{/* Hero Section */}
				<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-15 pt-20 md:pt-28 text-center">
				...
				{/* Grid Layout */}
				<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center pb-20 md:pb-28">
					{/* Image */}
					...
					{/* Text Box */}
					<div className="p-10 bg-white/70 rounded-3xl" data-aos="fade-left" data-aos-delay="200" data-aos-duration="600">
